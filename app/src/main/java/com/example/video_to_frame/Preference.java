...
public class Preference extends PreferenceActivity {
    ...
    android.preference.Preference listPreference;
    ...
    protected void onResume()
    {
        ...
        listPreference.setOnPreferenceChangeListener((android.preference.Preference.OnPreferenceChangeListener) (preference1, newValue) -> {
